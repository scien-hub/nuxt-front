...
<template>
    <div class="mx-auto max-w-6xl overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-gray-800">
        <!-- Editor Header -->
        <header class="flex items-center justify-between bg-gray-900 px-6 py-2 dark:bg-gray-950">
        ...
        <!-- Editor Content -->
        <div class="grid h-96 grid-cols-2 divide-x divide-gray-200 dark:divide-gray-700">
            <!-- LaTeX Source -->
            <div class="relative overflow-hidden bg-gray-50 dark:bg-gray-900">
                <div class="relative h-full overflow-y-auto p-6 font-mono text-sm leading-6">
...
Alice Chen and Bob Smith
                        ...
                        <div>
                            <h2 class="mt-6 mb-3 text-xl font-semibold text-gray-800 dark:text-gray-200">
                                Introduction
                            </h2>
